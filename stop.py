...
'as', 'at', 'against', 'between', 'into', 'fuck', 'damn', 'shit', 'through', 'above', 'below', 'to', 'from', 'up', 'down', 'in', 
...
'THAT', "THAT'LL", 'THESE', 'THOSE', 'AS', 'AT', 'AGAINST', 'BETWEEN', 'INTO', 'THROUGH',
...
'About', 'Against', 'Between', 'Into', 'Through', 'Above', 'Fuck', 'Below', 'To', 'From', 'Up', 'Down', 'In', 'Out', 'On', 'Off', 'Over', 
